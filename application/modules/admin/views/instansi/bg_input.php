				...
				<div class="row-fluid">
					<div class="span12">
						<div class="widget-box">
							...
							<div class="well">
								<?php echo form_open_multipart("admin/instansi/simpan"); ?>
								
								<label for="nama_instansi">Nama Instansi</label>
								<div class="cleaner_h5"></div>
								<input type="search" style="width:90%;" id="nama_instansi" name="nama_instansi" placeholder="nama instansi" value="<?php echo $nama_instansi; ?>" />
