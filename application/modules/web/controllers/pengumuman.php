...
class pengumuman extends CI_Controller {
	...
	function index($uri=0)
	{
		...
		$this->breadcrumb->append_crumb('pengumuman',  base_url());
	...
	function detail($param=0)
	{
		...
		$d['data_retrieve'] = $this->app_global_web_model->generate_detail_pengumuman($param);
		
		
 		$this->load->view($GLOBALS['site_theme'].'/web/bg_header',$d);
 		$this->load->view($GLOBALS['site_theme'].'/web/bg_left');
 		$this->load->view($GLOBALS['site_theme'].'/web/pengumuman/bg_detail');
 		$this->load->view($GLOBALS['site_theme'].'/web/bg_right');
 		$this->load->view($GLOBALS['site_theme'].'/web/bg_footer');
	}
}
