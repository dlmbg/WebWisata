...
class statistik extends CI_Controller {
	...
	function index($uri=0)
	{
		...
		$this->breadcrumb->append_crumb('Statistik Kunjungan',  base_url());
		...
		$d['data_retrieve'] = $this->app_global_web_model->generate_index_kunjungan_hotel(20,$uri);
		
 		$this->load->view($GLOBALS['site_theme'].'/web/bg_header',$d);
 		$this->load->view($GLOBALS['site_theme'].'/web/statistik/bg_home');
