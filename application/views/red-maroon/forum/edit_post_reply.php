...
<tr>
<td colspan="2">
<textarea class="ckeditor" cols="40" name="isi" style="width:100%; height:220px; resize:none; outline:none; font-family:Arial; background-color:#FFFFFF; font-size:12px;" placeholder="Ketikkan isi thread..."><?php echo $isi; ?></textarea>
